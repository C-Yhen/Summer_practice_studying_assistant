...
async function submit() {
  if (!await formRef.value?.validate().catch(() => false) || !form.agree) return
  await auth.register(form.name, form.email, form.password)
  ElMessage.success('账号创建成功，欢迎加入 StudyPilot')
