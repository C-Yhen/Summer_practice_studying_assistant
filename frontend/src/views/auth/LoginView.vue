...
const form = reactive({ email: 'demo@studypilot.cn', password: 'Demo@123456', remember: true })
...
async function submit() {
  ...
  ElMessage.success('欢迎回来，今日计划已为你准备好')
  ...
  <main class="auth-page">
    ...
    <section class="auth-form-pane">
      ...
      <div class="auth-box">
        ...
        <el-alert class="demo-alert" title="答辩演示账号已自动填充，直接登录即可" type="info" :closable="false" show-icon />
        <el-form ref="formRef" :model="form" :rules="rules" label-position="top" @keyup.enter="submit">
          ...
          <div class="form-options"><el-checkbox v-model="form.remember">保持登录状态</el-checkbox><button type="button">忘记密码？</button></div>
