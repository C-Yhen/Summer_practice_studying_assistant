    ...
    <section class="auth-form-pane">
      ...
      <div class="auth-box">
        ...
        <el-form ref="formRef" :model="form" :rules="rules" label-position="top" @keyup.enter="submit">
          ...
          <div class="form-options"><span>登录信息仅保存在当前标签页</span><span class="unavailable">忘记密码（暂未开放）</span></div>
