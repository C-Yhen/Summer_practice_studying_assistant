...
export const navigationGroups: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      { path: '/plan', label: '学习计划', group: '开始学习', keywords: ['计划', '排期', 'ai'], icon: Calendar, onboardingTarget: 'plans' },
    ],
  },
  {
    label: 'AI 学习',
    items: [
      { path: '/chat', label: 'AI 问答', group: 'AI 学习', keywords: ['问答', '聊天', 'chat', 'ai'], icon: ChatDotRound, onboardingTarget: 'chat' },
      { path: '/practice', label: '练习与错题', group: 'AI 学习', keywords: ['练习', '答题', '错题', '复习'], icon: Reading, onboardingTarget: 'practice' },
