...
from .client import BackendClient, sanitize_audit_value
...
async def _audit_safely(**kwargs: Any) -> None:
    """Audit delivery is best effort and must never replace a tool result."""
    try:
        await client.audit(**kwargs)
    except Exception:
        return
...
async def _calendar_preview(*, tool_name: str, user_id: int, payload: dict[str, Any], path: str, access_token: str, json: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        await _audit_safely(user_id=user_id, access_token=access_token, agent_run_id=str(uuid.uuid4()), tool_name=tool_name, input_data=payload, output_data=sanitize_audit_value(safe_output), status="waiting_for_user", error=None, started_at=started_at)
        ...
        await _audit_safely(user_id=user_id, access_token=access_token, agent_run_id=str(uuid.uuid4()), tool_name=tool_name, input_data=payload, output_data=None, status="failed", error=str(exc), started_at=started_at)
...
async def get_user_courses(user_id: int, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_user_courses", user_id=user_id, input_data={}, access_token=access_token, operation=lambda: client.request("GET", "/courses", user_id=user_id, access_token=access_token))
...
async def get_user_profile(user_id: int, course_id: int | None = None, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_user_profile", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/users/me/profile", user_id=user_id, access_token=access_token, params=params))
...
async def get_learning_history(user_id: int, course_id: int, limit: int = 30, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_learning_history", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/learning-records", user_id=user_id, access_token=access_token, params=params))
...
async def get_knowledge_mastery(user_id: int, course_id: int, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_knowledge_mastery", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/mastery", user_id=user_id, access_token=access_token, params=params))
...
async def get_study_plan(user_id: int, course_id: int, access_token: str = "") -> dict[str, Any]:
    ...
    params = {"course_id": course_id}
    return await _run(tool_name="get_study_plan", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/plans/current", user_id=user_id, access_token=access_token, params=params))
...
async def get_today_tasks(user_id: int, course_id: int | None = None, access_token: str = "") -> dict[str, Any]:
    """查询今日任务。只读，不需要确认。"""
    params = {"course_id": course_id} if course_id else {}
    return await _run(tool_name="get_today_tasks", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/plans/tasks/today", user_id=user_id, access_token=access_token, params=params))
...
async def create_study_task(user_id: int, plan_id: int, task: dict[str, Any], confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _write_with_confirmation(tool_name="create_study_task", user_id=user_id, payload=payload, confirmation_token=confirmation_token, access_token=access_token, operation=lambda: client.request("POST", f"/plans/{plan_id}/tasks", user_id=user_id, access_token=access_token, json=task, idempotency_key=idempotency_key))
...
async def update_task_status(user_id: int, task_id: int, status: str, actual_minutes: int | None = None, confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _write_with_confirmation(tool_name="update_task_status", user_id=user_id, payload=payload, confirmation_token=confirmation_token, access_token=access_token, operation=lambda: client.request("PATCH", f"/plans/tasks/{task_id}", user_id=user_id, access_token=access_token, json=payload, idempotency_key=idempotency_key))
...
async def get_wrong_questions(user_id: int, course_id: int, only_unmastered: bool = True, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_wrong_questions", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/wrong-questions", user_id=user_id, access_token=access_token, params=params))
...
async def recommend_resources(user_id: int, course_id: int, limit: int = 5, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="recommend_resources", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/recommendations/resources", user_id=user_id, access_token=access_token, params=params))
...
async def recommend_exercises(user_id: int, course_id: int, limit: int = 5, access_token: str = "") -> dict[str, Any]:
    ...
    params = {"course_id": course_id, "limit": min(max(limit, 1), 20)}
    return await _run(tool_name="recommend_exercises", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/recommendations/exercises", user_id=user_id, access_token=access_token, params=params))
...
async def search_course_material(user_id: int, course_id: int, query: str, top_k: int = 5, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="search_course_material", user_id=user_id, input_data=payload, access_token=access_token, operation=lambda: client.request("POST", "/rag/search", user_id=user_id, access_token=access_token, json=payload))
...
async def get_available_time(user_id: int, start_at: str, end_at: str, minimum_minutes: int = 30, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="get_available_time", user_id=user_id, input_data=params, access_token=access_token, operation=lambda: client.request("GET", "/calendar/availability", user_id=user_id, access_token=access_token, params=params))
...
async def create_calendar_event(user_id: int, event: dict[str, Any], confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="create_calendar_event", user_id=user_id, input_data=payload, access_token=access_token, operation=lambda: client.request("POST", "/calendar/events", user_id=user_id, access_token=access_token, json=payload, idempotency_key=idempotency_key, confirmation_token=confirmation_token))
...
async def update_calendar_event(user_id: int, event_id: int, changes: dict[str, Any], confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="update_calendar_event", user_id=user_id, input_data=payload, access_token=access_token, operation=lambda: client.request("PATCH", f"/calendar/events/{event_id}", user_id=user_id, access_token=access_token, json=changes, idempotency_key=idempotency_key, confirmation_token=confirmation_token))
...
async def delete_calendar_event(user_id: int, event_id: int, confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="delete_calendar_event", user_id=user_id, input_data=payload, access_token=access_token, operation=lambda: client.request("DELETE", f"/calendar/events/{event_id}", user_id=user_id, access_token=access_token, idempotency_key=idempotency_key, confirmation_token=confirmation_token))
...
async def reschedule_study_plan(user_id: int, plan_id: int, reason: str, available_minutes_per_day: int | None = None, confirmation_token: str = "", idempotency_key: str = "", access_token: str = "") -> dict[str, Any]:
    ...
    return await _write_with_confirmation(tool_name="reschedule_study_plan", user_id=user_id, payload={"plan_id": plan_id, **payload}, confirmation_token=confirmation_token, access_token=access_token, operation=lambda: client.request("POST", f"/plans/{plan_id}/reschedule", user_id=user_id, access_token=access_token, json=payload, idempotency_key=idempotency_key))
...
async def generate_weekly_report(user_id: int, course_id: int, week_start: str, access_token: str = "") -> dict[str, Any]:
    ...
    return await _run(tool_name="generate_weekly_report", user_id=user_id, input_data=payload, access_token=access_token, operation=lambda: client.request("POST", "/tasks", user_id=user_id, access_token=access_token, json=payload, idempotency_key=f"weekly-report:{user_id}:{course_id}:{week_start}"))
